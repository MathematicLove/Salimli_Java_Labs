First lab was maded in vim (text editor). Fully made with MacOs terminal. (a random string generator with length input) // to run: mvn exec:java | to test: mvn test.
